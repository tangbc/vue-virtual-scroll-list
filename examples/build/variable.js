...
// module
exports.push([module.i, "\n.item {\n    position: relative;\n    padding-left: 20px;\n    box-sizing: border-box;\n    border-bottom: 1px solid #eee;\n}\n.px {\n    position: absolute;\n    right: 20px;\n    font-size: 12px;\n    color: #ccc;\n}\n", "", {"version":3,"sources":["/Users/tangbichang/Github/vue-virtual-scroll-list/examples/variable/item.vue?49fa143c"],"names":[],"mappings":";AA0BA;IACA,mBAAA;IACA,mBAAA;IACA,uBAAA;IACA,8BAAA;CACA;AACA;IACA,mBAAA;IACA,YAAA;IACA,gBAAA;IACA,YAAA;CACA","file":"item.vue","sourcesContent":["<template>\n    <div class=\"item\" :style=\"style\">\n        <span>Item # {{ index }}</span>\n        <i class=\"px\">{{ height }}px</i>\n    </div>\n</template>\n\n<script>\n    export default {\n        props: {\n            index: Number,\n            height: Number\n        },\n\n        computed: {\n            style () {\n                return {\n                    'height': this.height + 'px',\n                    'line-height': this.height + 'px'\n                }\n            }\n        }\n    }\n</script>\n\n<style>\n    .item {\n        position: relative;\n        padding-left: 20px;\n        box-sizing: border-box;\n        border-bottom: 1px solid #eee;\n    }\n    .px {\n        position: absolute;\n        right: 20px;\n        font-size: 12px;\n        color: #ccc;\n    }\n</style>\n"],"sourceRoot":""}]);

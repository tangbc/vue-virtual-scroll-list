...
const VirtualList = Vue.component('virtual-list', {
  ...
  methods: {
    ...
    getRenderSlots (h) {
      ...
      const { dataSources, dataKey, itemClass, itemTag, itemStyle, isHorizontal, extraProps, dataComponent, itemScopedSlots, enableNextSource, enablePreviousSource } = this
